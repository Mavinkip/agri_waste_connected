...
class County {
  ...
  factory County.fromJson(Map<String, dynamic> json) {
    return County(
      ...
      subCounties: List<String>.from(json['subCounties'] as List),
    );
  }
...
class KenyaLocations {
  static List<County> getDefaultCounties() {
    return [
      County(name: 'Nairobi', subCounties: ['Nairobi Central', 'Westlands', 'Kasarani']),
      County(name: 'Kisumu', subCounties: ['Kisumu Central', 'Kisumu East', 'Kisumu West']),
      County(name: 'Mombasa', subCounties: ['Mombasa Island', 'Nyali', 'Likoni']),
      County(name: 'Kiambu', subCounties: ['Kiambu Town', 'Thika', 'Limuru', 'Githunguri']),
